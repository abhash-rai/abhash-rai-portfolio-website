    ...
    >
      ...
      {awards.map((award, index) => (
        <a
          ...
          key={index}
          className={`${gray_color} awards_cards flex flex-col sm:flex-row gap-5 lg:gap-8 box-border rounded-none lg:rounded-xl p-6 bg-[#424b5e0e] lg:bg-transparent lg:hover:bg-[#424b5e0e] lg:hover:shadow-md hover:lg:!scale-105 !transition-all !duration-300 !ease-in-out`}
        >
